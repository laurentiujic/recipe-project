...
create table ingredient (id bigint not null auto_increment, amount decimal(19,2), description varchar(255), recipe_id bigint, unitOfMeasure_id bigint, primary key (id)) engine=InnoDB;
...
alter table ingredient add constraint FK6iv5l89qmitedn5m2a71kta2t foreign key (unitOfMeasure_id) references unit_of_measure (id);
